...
# This is the startup script for MACOS The file `com.startup.plist` is
# copied to /Library/LaunchAgents and loaded permanently using `sudo
# launchctl load -w /Library/LaunchAgents/com.startup.plist`.  To stop the
